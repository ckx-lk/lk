...
(function () {
  ...
  var DEFAULT_LAWYERS = [
    ...
    { id: 'law_5', name: '宏敏莹', position: '专职律师', photo: 'images/hong_minying.jpg', intro: '宏敏莹，广东兰凯律所专职律师。商务英语本科，法律硕士，持有专八、法语中级证书，通晓普通话、粤语、客家话、英语、法语。主攻涉外法律，擅长外资并购、国际商事合同、经销合规、跨境纠纷，擅长把控跨境交易风险，为中外客户提供专业合规法律服务。', specialties: ['跨境投资并购', '涉外争议解决', '民商事诉讼', '企业法律顾问'] },
    { id: 'law_6', name: '余光统', position: '专职律师', photo: 'images/yu_guangtong.jpg', intro: '余光统律师曾在广州某国有建筑工程公司担任公司法务，在职多年期间常参与处理公司的重大疑难案件，积累了丰富的公司法律事务处理经验；同时在执业期间专注于：企业常年法律顾问和民商事领域（建设工程、建材购销、借款合同、租赁合同、买卖合同等）丨劳动人事领域（确认劳动关系、违法辞退赔偿金、工伤认定等）丨刑事领域（诈骗类犯罪、经济类犯罪等）。', specialties: ['企业常年法律顾问', '民商事领域', '劳动人事领域', '刑事领域'] },
    { id: 'law_7', name: '王永玉', position: '专职律师', photo: 'images/wang_yongyu.jpg', intro: '王永玉律师是一名在广州执业二十余年的专职律师，经办案件类型覆盖婚姻家庭与财产继承、商标权及专利权纠纷、经济合同纠纷、借款纠纷、刑事案件等多个领域；同时曾担任软件开发、电商、建设工程、股权基金等多行业企业的法律顾问，积累了丰富的实务经验。', specialties: ['婚姻家庭与财产继承', '商标权及专利权纠纷', '经济合同纠纷', '借款纠纷', '刑事案件'] }
  ];
