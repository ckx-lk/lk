...
-- 律师数据
INSERT INTO lawyers (name, position, specialties, photo, intro, sort_order) VALUES ('彭大成', '合伙人', '民商事诉讼、合同纠纷、公司法务', 'images/peng_dacheng.jpg', '广东兰凯律师事务所合伙人，资深律师，具有丰富的诉讼实务经验，擅长处理复杂民商事争议。', 1);
INSERT INTO lawyers (name, position, specialties, photo, intro, sort_order) VALUES ('陈康祥', '合伙人', '民事诉讼、劳动争议、交通事故', 'images/chen_kangxiang.jpg', '广东兰凯律师事务所合伙人，广东财经大学信息学院校友，执业领域以民事诉讼为主，代理案件涵盖合同纠纷、劳动争议、交通事故赔偿等多个领域。', 2);
INSERT INTO lawyers (name, position, specialties, photo, intro, sort_order) VALUES ('宏敏莹', '执业律师', '知识产权、公司法律事务、合同审查', 'images/hong_minying.jpg', '广东兰凯律师事务所执业律师，专注于知识产权保护与公司法律事务，具有扎实的法学理论功底和实务操作能力。', 3);
