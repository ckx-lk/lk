...
INSERT INTO lawyers (name, position, specialties, photo, intro, sort_order) VALUES ('陈重维', '合伙人', '婚姻家庭、继承纠纷、知识产权', 'images/chen_chongwei.jpg', '广东兰凯律师事务所合伙人，擅长婚姻家庭、继承纠纷、知识产权等领域，工作细致认真，深受客户信赖。', 3);
